...
const projects: Project[] = [
  ...
  {
    id: 4, title: 'Tripolo', tag: 'Travel · Website',
    badge: 'Live', badgeClass: 'bg-emerald-500',
    gradient: 'from-red-500 to-orange-400', icon: '✈️', image: 'tripolo.jpg',
    desc: 'Smart travel planning website with AI-powered itinerary generation, real-time flight tracking, hotel recommendations, and collaborative trip planning features.',
  ...
  {
    id: 1, title: 'Baggi.ae', tag: 'Luggage Service · UAE',
    badge: 'Web', badgeClass: 'bg-amber-500',
    gradient: 'from-blue-600 to-cyan-400', icon: '🧳', image: 'baggi.jpg',
    desc: 'Service portal for the UAE market offering on-demand luggage storage & delivery, with real-time tracking and an Arabic/English bilingual interface. Currently serving customers across Dubai.',
    tech: ['React.js', 'Node.js', 'MongoDB', 'Payment Gateway'],
